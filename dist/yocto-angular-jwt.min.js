...
"use strict";angular.module("yocto-angular-jwt",["angular-jwt","LocalStorageModule"]).provider("jwtConstant",function(){var a={refreshDelay:6e4,refreshUrl:"#",localStorage:{prefix:"jwt",type:"localStorage",cookie:{storage:{expire:0,path:"/"},domain:"*",notify:{enableSet:!1,enableDelete:!1}}},autoStart:!1},b=function(b){angular.merge(a,b)};return{set:b,$get:function(){return{set:b,keys:function(){return a}}}}}).config(["$httpProvider","localStorageServiceProvider","jwtConstantProvider",function(a,b,c){var d=c.keys();console.log(d),console.log(c),a.interceptors.push("httpJwtInterceptor"),b.setPrefix(d.localStorage.prefix),b.setStorageType(d.localStorage.type),b.setStorageCookie(d.localStorage.cookie.storage.expire,d.localStorage.cookie.storage.path),b.setStorageCookieDomain(d.localStorage.cookie.domain),b.setNotify(d.localStorage.cookie.notify.enableSet,d.localStorage.cookie.notify.enableDelete)}]).service("httpJwtToken",["localStorageService","jwtConstant","$http",function(a,b,c){return{refreshToken:function(){c.get(b.refreshUrl,{headers:{"x-jwt-ignore-check":!0}}).then(function(b){a.set("x-jwt-token",b.data)},function(){})}}}]).factory("httpJwtCore",["jwtHelper","localStorageService","jwtConstant",function(a,b,c){return{addAccessToken:function(a){var c=b.get("x-jwt-token");return null!==c&&angular.extend(a.headers,{"x-jwt-access-token":b.get("x-jwt-token"),"x-jwt-ignore-decrypt":!0}),_.has(a.data,"data")&&(a.data.data=JSON.stringify(a.data.data)),a},isExpired:function(){var c=b.get("x-jwt-token");return a.isTokenExpired(c)},decode:function(b){if(b.config&&b.config.url!==c.refreshUrl&&angular.isArray(b.data)){var d=a.decodeToken(b.data[0]);if(angular.isObject(d)){var e=["iss","sub","aud","exp","nbf","iat","jti"];angular.forEach(e,function(a){delete d[a]}),b.data=d}}return b}}}]).factory("httpJwtInterceptor",["$q","httpJwtCore",function(a,b){return{request:function(a){return b.addAccessToken(a)},response:function(a){return b.decode(a)},responseError:function(a){return b.decode(a)}}}]).run(["$interval","httpJwtToken","jwtConstant",function(a,b,c){c.autoStart&&(a(function(){b.refreshToken()},c.refreshDelay),b.refreshToken())}]);